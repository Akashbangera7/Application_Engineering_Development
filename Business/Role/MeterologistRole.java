 ...
 * @author adith
 */
public class MeterologistRole extends Role {
    ...
    public JPanel createWorkArea(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise,EnterpriseDirectory dir, EcoSystem business) {
        ...
        return new AirAmbulanceManageEmployeeJPanel(userProcessContainer, enterprise);
    }

     @Override
    public String toString(){
        return RoleType.MeterologistRole.getValue();
    }
