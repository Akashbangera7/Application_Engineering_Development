...
public class ManageNetworkJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 140, 404, 91));

        jLabel1.setFont(new java.awt.Font("Times New Roman", 1, 13)); // NOI18N
        jLabel1.setText("Name");
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 280, -1, -1));
        ...
        add(submitJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 320, -1, -1));
        ...
        add(nameJTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 280, 130, -1));
        ...
        add(backJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 450, -1, -1));

        jLabel4.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        jLabel4.setText("Manage Network Panel");
        add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 70, 300, 20));
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        ...
        if(!name.equals("")&& name.matches("^[a-zA-Z]*$")){
            for(Network network:system.getNetworkList())
            {
               ...
               {
                   JOptionPane.showMessageDialog(null, "Network already present.Please add new network");
                   return;
               }
            }
